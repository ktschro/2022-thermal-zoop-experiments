...
####Prevalence
```{r,message=FALSE,warning=FALSE}
ggplot(data,aes(x=sample_date,y=daphnia_prev, color=temp))+ geom_point() + geom_line(aes(group = bucket)) + scale_color_discrete() + facet_grid(rows= vars(temp), cols = vars(community)) +theme_bw() + ylab("Daphnia Inf Prev (log scale)") + ggtitle("Daphnia Prev")
